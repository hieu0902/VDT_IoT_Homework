...
#define ssid "TP-Link_E008_5G"
#define password "73184768"
const char* mqtt_server = "mqttvcloud.innoway.vn";
const char* mqttUser = "hieu";
const char* mqttPassword = "mVNeHEbUZXLIKeWuF0LU3ObCEKBNu2Kn";
...
void callback(char* topic, byte* message, unsigned int length) {
  ...
  if (String(topic) == "message/control/white") {
    ...
    //Led change brightness by analog
